...
router.put('/:id/issue-status', asc.updateIssueStatus);
router.get('/:id/issues', asc.getServiceIssues);
router.post('/:id/issues', asc.addServiceIssueEntry);
router.put('/:serviceId/issues/:issueId', asc.updateServiceIssueEntry);
router.put('/:serviceId/issues/:issueId/status', asc.updateServiceIssueEntryStatus);
