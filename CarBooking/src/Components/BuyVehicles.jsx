          ...
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl border border-sky-400/40 w-full max-w-5xl shadow-2xl shadow-sky-500/30 my-4 sm:my-8">
            ...
            <div className="overflow-y-auto max-h-[calc(90vh-180px)] custom-scrollbar">
              <div className="p-4 sm:p-8 space-y-8">
                ...
                <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700/50">
                  <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                    <FaCheckCircle className="text-emerald-400" /> Vehicle
                    Condition
                  </h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {[
                      {
                        label: "RC Available",
                        value: selectedVehicle.rc_available,
                      },
                      {
                        label: "Insurance",
                      ...
                      {
                        label: "PUC Available",
                        value: selectedVehicle.puc_available,
                      },
                      {
                        label: "Road Tax Paid",
                        value: selectedVehicle.road_tax_paid,
                      },
                    ].map((item, idx) => (
                      <div
                        key={idx}
