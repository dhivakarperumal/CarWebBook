...
const pageTitles = {
  ...
  "/admin/assignservices": "Assign Services",
  "/admin/services": "Active Services",
  "/admin/customers": "Customers",
  "/admin/billing": "Billing",
  "/admin/service-areas": "Service Areas",
  "/admin/allProducts": "Products",
  "/admin/productbilling": "Product Billing",
  "/admin/stockdetails": "Spare Parts Stock",
  "/admin/orders": "Orders",
  "/admin/inventory": "Parts Inventory",
  "/admin/inventory-list": "Vehicle Inventory",
  "/admin/add-vehicle": "Add New Vehicle",
  "/admin/employees": "Technicians",
  "/admin/overall-attendance": "Staff Attendance",
  ...
  "/admin/bikes": "Bike Inventory",
  "/admin/addbike": "Add Bike Details",
