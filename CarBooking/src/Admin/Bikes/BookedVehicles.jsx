                  ...
                  {(b.status || "").toLowerCase() === "cancelled" ? (
                    ...
                    <div className="relative group/status">
                      <select 
                        ...
                        className={`w-full px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest outline-none border transition-all cursor-pointer text-center appearance-none shadow-sm hover:scale-[1.02] active:scale-[0.98] ${
                          (b.status || "").toLowerCase() === "sold" 
